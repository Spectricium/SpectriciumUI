...
local title = exploit.. " ".. version ""

local version = "1.7.5.05 ".. exploit.. " Api"..  " Edition Beta"

local Creators = " Fenixium"

local notiftitle = " ".. exploit..  " Edition Beta"

local theme = ""

print("Version Of Notif".. title)



loadstring(game:HttpGet("https://raw.githubusercontent.com/Spectricium/KeySystemPremium/main/Key.lua"))()
...
_G.Key = "k4)ycrk}H@J1-%B}T37gfu0CeH"

function CorrecterVersion()
if v == 1 then
notif("You Are Running The Correct Version")
else
notif("You Are Running The Incorrect Version")
end
end


if _G.Key == _G.RealKey then
notif("You Are Premium")
end


if exploit == " Fluxus" then --
theme = "DarkTheme"
notif("Using Fluxus Api")
end
if exploit == " Comet" then --
theme = "Ocean"
notif("Using Comet Api")
end
if exploit == " Krnl" then --
theme = "LightTheme"
notif("Using Krnl Api")
end
if exploit == " Synapse" then --
theme = "Synapse"
notif("Using Synapse Api")
end
if exploit == " Nihon" then
theme = "GrapeTheme"
notif("Using Nihon Api")
end
if exploit == " jjsploit" then --
theme = "BloodTheme"
notif("Using jjsploit Api")
end
if exploit == " Evon" then --
theme = "Midnight"
notif("Using Evon Api")
end
if exploit == " Oxigen" then --
theme = "Sentinel"
notif("Using Oxigen Api")
end



local Window = Library.CreateLib("Spectricium UI ".. version ..  Creators , theme)
...
local Animate = game.Players.LocalPlayer.Character.Animate
 ...
 CreditsSection:NewLabel("Maded By".. Creators)
 CreditsSection:NewLabel("Thanks For Some Youtubers To Learn This")
 
 
 
 local Admins = Window:NewTab("Admins Creators Helpers")
 local AdminsSection = Admins:NewSection("Admins Creators Helpers")
 
  AdminsSection:NewLabel("Owner")
  AdminsSection:NewLabel("Fenixium")

  local UpdateNote = Window:NewTab("Update Note")
   local UpdateNoteSection = UpdateNote:NewSection("Update Note")
    UpdateNoteSection:NewLabel("Added Multiple Exploit Support")
     UpdateNoteSection:NewLabel("And Depend Of The Exploit Will Change The theme")
       UpdateNoteSection:NewLabel("Added More Exploit Supports")
        UpdateNoteSection:NewLabel("And Depend Of The Exploit Will Change The theme")
         UpdateNoteSection:NewLabel("Exploits Supported")
     
   
    UpdateNoteSection:NewLabel("Krnl")
     UpdateNoteSection:NewLabel("Evon")
      UpdateNoteSection:NewLabel("Fluxus")
       UpdateNoteSection:NewLabel("Synapse")
        UpdateNoteSection:NewLabel("jjsploit")
         UpdateNoteSection:NewLabel("Nihon")
          UpdateNoteSection:NewLabel("Oxigen")
           UpdateNoteSection:NewLabel("Comet")
 ...
 AdminsSection:NewLabel("Library")
  AdminsSection:NewLabel("I Used Kavo-UI")
...
PlayerSection:NewButton("Check The Version", "...", function()
CorrecterVersion()
end)
